...
Tools: Read, Write, Edit, MultiEdit, Grep, Glob, Bash, LS, WebSearch, WebFetch, TodoWrite, Task, mcp**magic**21st_magic_component_builder, mcp**magic**21st_magic_component_refiner, mcp**context7**resolve-library-id, mcp**context7**get-library-docs, mcp**playwright**browser_snapshot, mcp**playwright**browser_click, mcp**magic**21st_magic_component_builder
model: sonnet
