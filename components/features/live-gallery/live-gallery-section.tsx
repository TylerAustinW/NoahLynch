				...
				<div className="container mx-auto max-w-6xl">
					...
					>
						...
						<div id="Social-Link" className="text-zinc-200 text-md mb-4">
							<p className="text-zinc-200 text-md">Follow @noahlynchmusic on social media for more behind-the-scenes content</p>
						</div>
								...
								>
									...
									<div className="absolute bottom-0 left-0 right-0 p-6 text-white bg-gradient-to-t from-black/90 via-black/70 to-transparent">
										<div className="space-y-2">
											...
											{hasGallery && <p className="text-xs text-amber-400 mt-2">Click to view gallery</p>}
										</div>
									</div>
								</motion.div>
							);
								...
								<div className="relative inline-block max-w-full max-h-full">
									...
									<Image
										...
										className={`w-auto h-auto max-w-full max-h-[80vh] object-contain rounded-lg transition-opacity duration-300 ${
											imageLoadingStates[`${selectedVenue.id}-${currentPhotoIndex}`] ? "opacity-0" : "opacity-100"
										}`}
										width={1200}
										height={800}
