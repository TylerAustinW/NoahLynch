				...
				<div className="grid gap-12 lg:grid-cols-2 lg:gap-16 xl:gap-20">
					...
					>
						<div className="space-y-6 text-lg leading-relaxed text-white md:text-xl max-w-none md:max-w-[65ch]">
							<p>
								<span className="font-bold text-amber-400 text-xl md:text-2xl">Noah Lynch</span> is an acoustic pop
								singer-songwriter who takes inspiration from <span className="font-semibold text-amber-400">John Mayer</span>,
								blending heartfelt storytelling with smooth, soulful melodies. Coming from a small town where pursuing music isn't
								the obvious path, Noah has carved his own journey, proving that passion and persistence can break through any
								limitation.
							</p>
							...
							>
								<p>
									...
									lyrics and engaging performances, Noah connects deeply with audiences, turning everyday experiences into songs
									that resonate long after the music stops.
								</p>
							</motion.div>
