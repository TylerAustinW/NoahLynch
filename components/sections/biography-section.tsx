...
export default function BiographySection() {
   ...
   return (
      <section
         id="biography"
         ref={ref}
         className="py-24 px-6 md:px-12 bg-gradient-to-b from-black via-zinc-950/99 to-black relative overflow-hidden
      ...
      >
         ...
         <div className="max-w-7xl mx-auto relative z-10">
            <h2 className="text-3xl md:text-5xl font-bold mb-8 text-white">Biography</h2>
