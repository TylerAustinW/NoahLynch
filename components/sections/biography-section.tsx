  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto relative z-10  ">
        <h2 className="text-3xl md:text-5xl font-bold mb-8 text-sky-100">
          Biography
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="text-gray-300 leading-relaxed text-lg">
              ...
              From those early days, Noah's passion for music has only grown
              stronger, fueling his desire to share his artistry with the world.
            </p>

            <p className="text-gray-300 leading-relaxed text-lg">
              Drawing inspiration from legends like John Mayer and Stevie Ray
              Vaughan, Noah's music blends the soulful melodies of blues with
              the infectious energy of neo-rock. His sound is a reflection of
              his upbringing in a small town nestled in Mississippi, where music
              isn't the typical claim to fame.
            </p>

            <p className="text-gray-300 leading-relaxed text-lg">
              Noah's upbringing was marked by the serenade of his guitar strings
              and the melodies that echoed through his soul. His authentic
              approach to songwriting captures the essence of human emotion,
              creating connections with listeners around the world.
            </p>
