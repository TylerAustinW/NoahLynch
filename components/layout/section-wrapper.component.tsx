...
export default function SectionWrapper({
	...
	return (
		<Component className={cn(backgroundClasses[background], spacingClasses[spacing], className)} {...props}>
			{container ? <div className={cn(sizeClasses[size], centered && "mx-auto", "w-full")}>{children}</div> : children}
		</Component>
	);
}
