export const ROUTES = {
  ...
  ASSETS: {
    HERO_VIDEO: '/noah-lynch-hero-video.mp4',
    MOBILE_BG: '/Mobile-Background.jpg',
    GRAIN_TEXTURE: '/grain-texture-overlay.png',
    PORTRAIT_GUITAR: '/noah-lynch-portrait-guitar.jpeg',
    STUDIO_BW: '/noah-lynch-studio-black-white.jpg',
    STUDIO_SESSION: '/noah-lynch-studio-session.jpeg',
    MAGNOLIA_SESSION: '/noah-lynch-magnolia-blues-session.jpg',
  },
