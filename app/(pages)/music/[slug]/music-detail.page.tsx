...
import MobileTabs from "@/components/features/music/mobile-tabs.component";
    ...
    const SpecialThanksContent = (
        <div className={`${patrickHand.className} text-center text-lg lg:text-xl leading-relaxed text-amber-100/90`}>
            <p className="text-center font-medium">
                Bringing "Honest" to life has been one of the most meaningful creative experiences of my life, and I couldn't have
                done it without the support, talent, and heart of some truly incredible people. To <strong>Levi Ready</strong>,{" "}
