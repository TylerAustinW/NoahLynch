...
import MobileTabs from "./components/mobile-tabs.component";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
	...
	const absoluteImageUrl = release.imageURL.startsWith("http") ? release.imageURL : `${siteUrl}${release.imageURL}`;
	...
	const SpecialThanksContent = (
		<div className={`${patrickHand.className} text-center text-lg lg:text-xl leading-relaxed text-amber-100/90`}>
			<p className="text-center font-medium">
				Bringing "Honest" to life has been one of the most meaningful creative experiences of my life, and I couldn't have done it
				without the support, talent, and heart of some truly incredible people. To <strong>Levi Ready</strong>,{" "}
				<strong>Isaac Moreno</strong>, <strong>Tyler Bridge</strong>, <strong>Jamie Wroten</strong>,{" "}
				<strong>Tyler Williams</strong>, <strong>Christopher Chittom</strong>, <strong>Evan Busbin</strong>,{" "}
				<strong>Hagen Brister</strong>, and <strong>Sherry Thibodeaux</strong>
				—thank you for your time, energy, and the unique ways each of you contributed to this song.
				<br />
				<br />
				And last but never least, to my amazing wife <strong>Hunter Lynch</strong> your love, strength, and unwavering belief in
				me are the foundation of everything I do. Thank you for being my home, my muse, and my greatest encouragement.
			</p>
