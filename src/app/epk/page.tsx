...
import { Award, Home, Mail, MapPin, Music, Play } from "lucide-react";
...
export default function EPKPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-zinc-950 text-white print:bg-white print:text-black">
      ...
      <header className="sticky top-0 z-50 border-b border-zinc-800/50 bg-zinc-950/95 outline outline-zinc-600/50">
        ...
        <div className="relative z-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between py-4">
              <Link
                href="/"
                className="inline-flex items-center gap-2 rounded-lg border border-zinc-700/50 bg-zinc-900/40 px-4 py-2 font-medium text-zinc-300 backdrop-blur-sm transition-all duration-300 hover:border-amber-500/50 hover:bg-zinc-800/60 hover:text-amber-400 focus:ring-2 focus:ring-amber-400/50 focus:outline-none"
              >
      ...
      <main className="relative z-20">
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-20">
          ...
          <div className="mt-8 flex justify-center">
            <Link
              href="/gallery"
              className="inline-flex items-center gap-2 rounded-full border border-zinc-700/30 bg-zinc-900/40 px-6 py-3 text-sm font-medium text-white backdrop-blur-sm transition-all duration-300 hover:border-amber-500/50 hover:bg-zinc-800/60 focus:ring-2 focus:ring-amber-400/50 focus:outline-none"
            >
              View Full Gallery
