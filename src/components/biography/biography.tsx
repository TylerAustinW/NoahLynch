        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 xl:gap-20">
          <div className="space-y-6">
            <div className="max-w-none space-y-6 text-lg leading-relaxed text-white md:max-w-[65ch] md:text-xl">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${isMobile && !isExpanded ? "max-h-0 opacity-0" : "max-h-[2000px] opacity-100"}`}
              >
                <p>
                  His{" "}
                  <Link
              ...
              {isMobile && (
                <button
                  ...
                  className="group inline-flex items-center gap-2 rounded-lg px-2 py-1 text-zinc-300 transition-all duration-300 hover:text-white focus:ring-2 focus:ring-zinc-400/50 focus:outline-none"
                >
